...
static void test_alpha_display() {
    ...
    printf("Enter up to 4 letters: ");
    gets(word);
    uint16_t displaybuffer[8];
    displaybuffer[0] = alphafonttable[(int)word[0]];
    displaybuffer[1] = alphafonttable[(int)word[1]];
    displaybuffer[2] = alphafonttable[(int)word[2]];
    displaybuffer[3] = alphafonttable[(int)word[3]];
    ...
    while (1) {
      ...
      printf("\nEnter up to 4 letters: ");
      gets(word);
      if (strlen(word) < 4){
        for (int i = strlen(word); i < 4; i++){
          word[i] = ' ';
        }
      }
      displaybuffer[0] = alphafonttable[(int)word[0]];
