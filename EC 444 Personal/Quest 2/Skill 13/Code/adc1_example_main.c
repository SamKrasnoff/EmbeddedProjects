...
static const uint16_t alphafonttable1[] = {
...
init();
    ...
    while (1) {
        ...
        float resistance = (10000.0*(3.3-voltage/1000.0))/(voltage/1000.0);
        float temperature = 1.0 / ((1.0 / 298.15) + (1.0 / 3435.0) * log(resistance/10000.0));
        printf("Resistance: %.2f  Temp: %.2f °C\n", resistance, temperature-278.15);
        float vol= voltage/1000;
        int temp1 = (int)(voltage/1000);
        displaybuffer[0]= alphafonttable1[temp1];
        int temp = (int)(voltage/100);
        displaybuffer[1]= alphafonttable[temp - (temp1*10)];
